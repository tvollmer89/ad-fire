    ...
    <div class="content-inner container">
      <div class="col-md-12">
        <div class="row">
          ...
          <p> <strong>2. Product Information</strong>
          </p>
          <p>
          ...
          <p>
            <strong>5. Modifications to Site</strong>
          </p>
          <p>
          ...
          <p>
            <strong>8. COMPANY&#39;s Proprietary Rights</strong>
          </p>
          <p>
          ...
          <p>
            <strong>9. Notices and Procedures for Making Claims of Copyright Infringement</strong>
          </p>
          <p>
          ...
          <p>
            ...
            THE PRECEDING INFORMATION IS PROVIDED EXCLUSIVELY FOR NOTIFYING COMPANY THAT YOUR COPYRIGHTED MATERIAL MAY HAVE BEEN INFRINGED. ALL OTHER INQUIRIES, SUCH AS PRODUCT-RELATED QUESTIONS AND REQUESTS, OR QUESTIONS ON PRIVACY, WILL NOT RECEIVE A RESPONSE THROUGH THIS PROCESS.
          </p>
          <p>
          ...
          <table>
            <thead>YOU EXPRESSLY UNDERSTAND AND AGREE THAT:</thead>
            <tbody>
              <tr>
                <td>(a)</td>
                <td>
              ...
              <tr>
                <td>(d)</td>
                <td>
                  NO ADVICE OR INFORMATION, WHETHER ORAL OR WRITTEN, OBTAINED BY YOU FROM COMPANY OR THROUGH OR FROM THE SITE SHALL CREATE ANY WARRANTY NOT EXPRESSLY STATED IN THESE TERMS OF USE OR OTHERWISE APPLICABLE PURSUANT TO YOUR PURCHASE OF COMPANY PRODUCTS OR SERVICES.
                </td>
              </tr>
            </tbody>
          </table>
          ...
          <p>
            <strong>11. Notice/Opt Out Options</strong>
          </p>
          <p>
